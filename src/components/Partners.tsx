...
const partners: Partner[] = [
  ...
  { 
    ...
    scale: 1.8 // Make Ernest Capital text 80% larger
  },
  { 
    name: "Visa", 
...
const Partners = () => {
  ...
  return (
    <section id="partners" className="py-16 md:py-24 px-4 md:px-6 bg-gray-50 text-center">
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 mb-12 max-w-3xl mx-auto">
            We partner with leading organizations to deliver exceptional IT solutions and staffing services.
          </p>
        </motion.div>
                  ...
                  <CardContent className="flex items-center justify-center p-6 h-32">
                    {partner.isText ? (
                      <div
                        ...
                        style={{
                          color: partner.textColor || "#000000",
                          backgroundColor: partner.bgColor || "transparent",
                          padding: "8px 16px",
                          borderRadius: "6px",
                      ...
                      <div style={{ transform: `scale(${partner.scale || 1})` }}>
                        {partner.svgContent}
                      </div>
                    ) : (
                      <img
